...
{
    public class BillSubordinateCannibalizeSearchVM : BillPagedReportVM<CannibalizeSearchEntity>
    {
            ...
            get
            {
                if (_filterDescriptors == null)
                {
                    ...
                    {  
                        ...
                        new FilterDescriptor("ToOrganizationID", FilterOperator.IsEqualTo, FilterDescriptor.UnsetValue)
                    };
                }
        ...
        protected override IEnumerable<CannibalizeSearchEntity> SearchData()
        {
            ...
            var cannibalizeContext = lp.Search<BillCannibalize>(o => oids.Contains(o.ToOrganizationID) && oids.Contains(o.OrganizationID) && brandIDs.Contains(o.BrandID));
