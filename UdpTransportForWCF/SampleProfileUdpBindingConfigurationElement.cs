...
namespace UdpTransportForWCF
{
    public class SampleProfileUdpBindingConfigurationElement : StandardBindingElement
    {
        ...
        [ConfigurationProperty(UdpConfigurationStrings.SendPort, DefaultValue = UdpDefaults.SendPort)]
        public int SendPort
        {
            get { return (int)base[UdpConfigurationStrings.SendPort]; }
            set { base[UdpConfigurationStrings.SendPort] = value; }
        }
        ...
        protected override ConfigurationPropertyCollection Properties
        {
            get
            {
                ...
                properties.Add(new ConfigurationProperty(UdpConfigurationStrings.SendPort,
                    typeof(int), UdpDefaults.SendPort, null, null, ConfigurationPropertyOptions.None));
        ...
        protected override void InitializeFrom(Binding binding)
        {
            ...
            this.Multicast = udpBinding.Multicast;
            this.SendPort = udpBinding.SendPort;
        ...
        protected override void OnApplyConfiguration(Binding binding)
        {
            ...
            udpBinding.Multicast = this.Multicast;
            udpBinding.SendPort = this.SendPort;
