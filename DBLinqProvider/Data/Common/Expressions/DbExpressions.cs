...
namespace DBLinqProvider.Data.Common
{
    ...
    public class BatchExpression : Expression
    {
            ...
            : base()
        {
            ...
            this.stream = stream;
            _nodeType = (ExpressionType)DbExpressionType.Batch;
            _type = typeof(IEnumerable<>).MakeGenericType(operation.Body.Type);
        }
    ...
    public class VariableExpression : Expression
    {
            ...
            : base()
        {
            this.name = name;
            this.queryType = queryType;
            _nodeType = (ExpressionType)DbExpressionType.Variable;
            _type = type;
        }
