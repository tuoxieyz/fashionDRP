...
namespace DBLinqProvider.Data.Mapping
{
    using Common;
    ...
    public class ImplicitMapping : BasicMapping
    {
        ...
        public override bool IsPrimaryKey(MappingEntity entity, MemberInfo member)
        {
            ...
            if (this.IsColumn(entity, member)) 
            {
                ...
                var attr = Attribute.GetCustomAttribute(member,typeof(ColumnAttribute)) as ColumnAttribute;
                if(attr != null)
        ...
        /// 根据名称获取两个关联实体相同的属性
        /// </summary>
        /// <param name="entity">实体甲</param>
        /// <param name="member">实体乙，作为实体甲的一个属性出现</param>
        /// <param name="keyMembers">实体甲中的关联属性</param>
        /// <param name="relatedKeyMembers">实体乙中的关联属性</param>
